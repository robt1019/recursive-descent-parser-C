...
void assign_var_test(FILE *test_fp, Program *test_program){
    ...
    fprintf(test_fp, "is correctly assigned the value 20\n");
    test_program->current_word = 0;
...
void interpret_varnum_test(FILE *test_fp, Program *test_program){
    ...
    fprintf(test_fp, "is correctly interpreted by the function and the value 20 is returned\n");
    test_program->current_word = 0;
    strcpy(test_program->words[test_program->current_word], "D");
    assign_var(test_program, 3, 20);
    Varnum(test_program);
...
void Lt_test(FILE *test_fp){
    ...
    fprintf(test_fp, "is updated correctly such that if it starts at 90 and turns 90 left\n");
    fprintf(test_fp, "the current angle is 180 (and the same for 360 turn from 180 leading to 180\n");
    fprintf(test_fp, "and 180 turn from 180 leading to 0)\n");
    fprintf(test_fp, "_________________________________________________________________________\n\n");
    double turn_angle;
    Co_ordinates c;
    c.current_angle = 90;
...
void Rt_test(FILE *test_fp){
    ...
    fprintf(test_fp, "is updated correctly such that if it starts at 0 and turns 90 left\n");
    fprintf(test_fp, "the current angle is 270 (and the same for 360 turn from 270 leading to 270\n");
    fprintf(test_fp, "and 180 turn from 270 leading to 90)\n");
    fprintf(test_fp, "_________________________________________________________________________\n\n");
    double turn_angle;
    Co_ordinates c;
    c.current_angle = 0;
